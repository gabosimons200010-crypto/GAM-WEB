    ...
    products: [
      {
        sku: 'NT-001',
        name: 'Polo Boxy Fit',
        slug: 'polo-boxy-fit-ntf',
        description: 'Polo boxy fit de algodón pesado, hombro caído y largo recortado.',
        gender: 'UNISEX',
        price: 45,
        tags: ['polo', 'boxy', 'ntf'],
        categorySlug: 'polos',
        imageUrls: ['/media/ph-ntf-polo-boxy.svg'],
        soldCount: 76,
        variants: SIZES.map((size) => ({ size, stock: 18 })),
      },
      {
        sku: 'NT-002',
        name: 'Camisa Boxy Fit',
        slug: 'camisa-boxy-fit-ntf',
        description: 'Camisa boxy de caída estructurada, botones al tono.',
        gender: 'UNISEX',
        price: 75,
        tags: ['camisa', 'boxy', 'ntf'],
        categorySlug: 'polos',
        imageUrls: ['/media/ph-ntf-camisa-boxy.svg'],
        soldCount: 32,
        variants: SIZES.map((size) => ({ size, stock: 10 })),
      },
      {
        sku: 'NT-003',
        name: "Hoodie God's Plan",
        slug: 'hoodie-gods-plan-ntf',
        description: "Hoodie God's Plan de french terry, capucha amplia y gráfico al pecho.",
        gender: 'UNISEX',
        price: 85,
        tags: ['hoodie', 'ntf'],
        categorySlug: 'polos',
        imageUrls: ['/media/ph-ntf-hoodie-gods.svg'],
        soldCount: 49,
        variants: SIZES.map((size) => ({ size, stock: 12 })),
      },
      {
        sku: 'NT-004',
        name: 'Baggy Jeans',
        slug: 'baggy-jeans-ntf',
        description: 'Baggy jean de pierna ancha y tiro medio, denim rígido.',
        gender: 'UNISEX',
        price: 120,
        tags: ['baggy', 'jean', 'ntf'],
        categorySlug: 'pantalones',
        imageUrls: ['/media/ph-ntf-baggy.svg'],
        soldCount: 38,
        variants: SIZES.map((size) => ({ size, stock: 9 })),
      },
      {
        sku: 'NT-005',
        name: "Tee God's Plan",
        slug: 'tee-gods-plan-ntf',
        description: "Tee God's Plan de algodón peinado con estampa frontal.",
        gender: 'UNISEX',
        price: 55,
        tags: ['tee', 'ntf'],
        categorySlug: 'polos',
        imageUrls: ['/media/ph-ntf-tee-gods.svg'],
        soldCount: 57,
        variants: SIZES.map((size) => ({ size, stock: 15 })),
      },
    ],
